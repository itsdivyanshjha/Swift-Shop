  ...
  return (
    <BaseComponent>
      <div className="About container mt-2" style={{ minHeight: "500px",textAlign:"justify" }}>
        <p>Welcome to <span className="fw-bold">Swift Shop!</span></p>
        <p>
          At SwiftShop, we are passionate about providing you with the best online
        ...
        <p>
          We also value your trust and privacy. At SwiftShop, we adhere to strict
        ...
        <p>
          Thank you for choosing SwiftShop. We appreciate your support and look
